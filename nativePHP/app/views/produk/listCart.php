	...
	<?php
		if (!empty($_SESSION['cart'])){
			$hrg=$byr=$jml=0;$nama="";						
			echo  "<a href='".BASEURL."/produk/removeCart' class='btn btn-danger text-white'>Kosongkan Cart</a>";
			echo "<p class='bg-info text-white'>Jml data :".sizeof($_SESSION['cart']['arrCart'])."</p>";			
			$max=sizeof($_SESSION['cart']['arrCart']);
			if ($max>0){
				echo  "<a href='".BASEURL."/produk/checkOut' class='btn btn-warning text-white'>ChekOut</a>";
			}
