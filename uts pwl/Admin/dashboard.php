...
<body>
    <nav class="nav nav-pills flex-sm-row bg-primary">
        ...
        <a class="flex-sm-fill text-sm-start nav-link text-light disable" href="#">User : <?= $user ;?> </a>
                ...
                <div class="card text-center">
                    <div class= "card-body">
                        <a href="listOrder.php">
                            <img src="order.png" class="rounded mx-auto d-block" alt="..." style="150px;width:180px;">
                        </a>
                    </div>
                    <div class="card-footer text-muted">
                        Order
                ...
                <div class="card text-center">
                    <div class= "card-body">
                        <a href="listMember.php">
                            <img src="Member.png" class="rounded mx-auto d-block" alt="..." style="150px;width:180px;">
                        </a>
                    </div>
                    <div class="card-footer text-muted">
                        Member
